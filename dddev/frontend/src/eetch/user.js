...
export const githubSync = async ({ code }) => {
  const url = `https://k9d103.p.ssafy.io:8000/oauth/sign-in?code=${code}`;
  const options = {
    method: 'GET',
    headers: {
...
export const githubTokenRegist = async ({ accessToken, refreshToken, personalAccessToken }) => {
  const url = `https://k9d103.p.ssafy.io:8000/user/personal-access-token`;
  const options = {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
export const userEdit = async ({ accessToken, refreshToken, nickname, statusMsg }) => {
  const url = `https://k9d103.p.ssafy.io:8000/user`;
  const options = {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
...
export const userNickname = async ({ accessToken, refreshToken, nickname }) => {
  const url = `https://k9d103.p.ssafy.io:8000/user/nickname/duplicate/${nickname}`;
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
...
export const userGrounds = async ({ accessToken, refreshToken }) => {
  const url = `https://k9d103.p.ssafy.io:8000/user/ground/list`;
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
...
export const changeLastGround = async ({ accessToken, refreshToken, groundId }) => {
  const url = `https://k9d103.p.ssafy.io:8000/user/last-ground/${groundId}`;
  const options = {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
...
export const userProfileImage = async ({ accessToken, refreshToken }) => {
  const url = `https://k9d103.p.ssafy.io:8000/user/profile`;
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
