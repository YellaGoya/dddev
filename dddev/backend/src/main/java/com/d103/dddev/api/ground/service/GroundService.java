...
public interface GroundService {
	...
	Map<String, Integer> getGroundFocusTime(Integer groundId, Integer sprintId, Integer status) throws Exception;
	Map<String, Integer> getGroundActiveTime(Integer groundId, Integer sprintId, Integer status) throws Exception;
