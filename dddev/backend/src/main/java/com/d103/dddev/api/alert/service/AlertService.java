...
public interface AlertService {
	...
	void createAlert(String header, Repository repository, List<String> keyword, String type) throws Exception;
	...
	void updateAlert(User user, UpdateAlertDto updateAlertDto, Integer alertId) throws Exception;
